...
A big data ülepítőhelye, mondjuk, akár egy Hadoop installáció lehetne, ahová szarul struktúrált (értsd: XML) adatfájlokat lehetne betölteni, hogy a bennük rejlő adatokat rá lehessen kapcsolni a központi adatmodellre - lásd rögtön alább!
